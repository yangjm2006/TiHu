...
public class FollowController {
    ...
    /**
     * 关注用户
     * POST /api/follows?followeeId=xxx
     */
    @PostMapping
    public Result followUser(@RequestParam Long followeeId) throws Exception {
    ...
    /**
     * 取消关注
     * DELETE /api/follows?followeeId=xxx
     */
    @DeleteMapping
    public Result unfollowUser(@RequestParam Long followeeId) throws Exception {
        Long userId = Long.parseLong(StpUtil.getLoginId().toString());
     ...
     */
    @GetMapping("/check")
    public Result checkFollowing(@RequestParam Long followeeId) {
        Long userId = Long.parseLong(StpUtil.getLoginId().toString());
        boolean following = followService.isFollowing(userId, followeeId);
